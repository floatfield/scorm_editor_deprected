defmodule ScormWeb.QuizController do
    ...
    def new(conn, %{"words" => words}) do
        %{
            ...
            "min_right_number" => min_right,
            "max_right_number" => max_right,
        ...
        {question_number, _ } = Integer.parse(question_n)
        {min_right_number, _} = Integer.parse(min_right)
        {max_right_number, _} = Integer.parse(max_right)
        {min_successful_series, _} = Integer.parse(min_success)
        json = %{
            "description" => description,
            "minSuccessSeries" => min_successful_series,
            "questionNumber" => question_number,
            "minRightNumber" => min_right_number,
            "maxRightNumber" => max_right_number,
            "right" => right,
            "wrong" => wrong,
            "marks" => marks
        }
